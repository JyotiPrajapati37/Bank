...
//				Previous Objects
				MMCurrentAcc cAcc = new MMCurrentAcc(101, "komal", accBal, creditLimit);
				MMSavingAcc sAcc = new MMSavingAcc(105, "Jyoti", accBal, true);
...
//						CURRENT ACCOUNT Object Creation
						...
						case 1:
							...
							System.out.println("CREDIT LIMIT: " + "Jyoti");
							break;
						case 2:
							System.out.println("Enter Ammount:");
							amt = sc.nextFloat();
